...
public class StudentManagerTest {
	...
	//查看所有学生
	public static void findAllStudent(ArrayList<Student2> array) {
		...
		//\t 其实就是一个tab键的位置
		System.out.println("学好\t姓名\t年龄\t居住地");
	...
	//删除学生
	public static void deleteStudent(ArrayList<Student2> array) {
	...
	//修改学生
	public static void updateStudent(ArrayList<Student2> array) {
